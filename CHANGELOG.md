...
### kernel (msm8937) (since pepito-23.2-r1)
- ASoC: tfa98xx: default pcm_no_constraint=1 (fixes intermittent silent calls)
- bhy: use native step detector/counter instead of the custom pedometer slot
